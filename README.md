...
Esse é um repositório que contém a automaçāo de alguns testes de API Rest de um software denominado Lojinha. Os sub-tópicos abaixo descrevem algumas decisōes tomadas na estrutura do projeto.
